...
def update_prices():
    ...
    while running:
        try:
            ...
            print(f"가격 업데이트 완료: {datetime.now()}")
...
if __name__ == '__main__':
    ...
    print("http://localhost:5678 에서 접속하세요.")
    print("웹소켓을 사용하여 실시간 데이터를 전송합니다.")
    
    try:
        socketio.run(app, host='0.0.0.0', port=5678, debug=True, allow_unsafe_werkzeug=True)
